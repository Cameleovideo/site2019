<%@ page language="VB" masterpagefile="~/general.master" autoeventwireup="false" inherits="vanier_Default, App_Web_mxmrlxzo" enableEventValidation="false" stylesheettheme="White" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Main2" Runat="Server">

    <div style="text-align:center;">       
        
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/Vanier_RVBSmall.gif" />
        <br /><br /><br/>    
                    ...
                    <tr align="left">
                        ...
                        <td>
                            <asp:DropDownList ID="lstFaculties" runat="server" Width="100%">
                                <asp:ListItem Value="VANIER 2010-2011"  meta:resourcekey="EventResource1"></asp:ListItem>                                
                                <asp:ListItem Value="VANIER 2010-2011"  meta:resourcekey="EventResource2"></asp:ListItem>                                
                            </asp:DropDownList>
                        </td>
                    </tr>
