<%@ page language="vb" masterpagefile="admin.master" autoeventwireup="true" inherits="admin_products, App_Web_kw1ulmho" title="Product Administration" stylesheettheme="Admin" validaterequest="false" enableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="AdminPlaceHolder" Runat="Server">
	...
	<asp:GridView ID="dgProducts" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID" OnRowDataBound="InventoryCheck" >
		<Columns>
			...
			<asp:BoundField DataField="LabUserName" HeaderText="LabUserName" SortExpression="LabUserName" />
			<asp:BoundField DataField="CheckLandscape" HeaderText="CheckLandscape" SortExpression="CheckLandscape" />
			<asp:BoundField DataField="UseOversizedEnvelopes" HeaderText="UseOversizedEnvelopes" SortExpression="UseOversizedEnvelopes" />
			<asp:BoundField DataField="ExportType" HeaderText="ExportType" SortExpression="ExportType" />
	   </Columns>
		...
		<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="100%">
				...
				<TD colSpan="2">
					<TABLE id="Table4" cellSpacing="1" width="100%" bgColor="gainsboro">
						<TR id="trID" runat="server">
							<TD bgColor="whitesmoke" style="width: 150px">ID</TD>
							<TD bgColor="white">
								<asp:Label id="lblID" runat="server"></asp:Label></TD>
						</TR>
						<TR>
							<TD bgColor="whitesmoke" style="width: 150px">Category</TD>
							<TD bgColor="white">
						...
						<TR>
							<TD bgColor="whitesmoke" style="width: 150px">Model Number</TD>
							<TD bgColor="white">
						...
						<TR>
							<TD bgColor="whitesmoke" style="width: 150px">Model&nbsp;Name</TD>
							<TD bgColor="white">
						...
						<tr>
							<td bgcolor="whitesmoke" style="width: 150px">
								SKU</td>
							<td bgcolor="white">
						...
						<TR>
							<TD bgColor="whitesmoke" style="width: 150px">Product Image</TD>
							<TD bgColor="white">
								<asp:Image id="imgProductImage" runat="server"></asp:Image><BR><br />
								<asp:textbox id="txtProductImage" runat="server"></asp:textbox> <A onclick="loadPix(); return false;" href="#">Select ...</A>
						...
						<TR>
							<TD bgColor="whitesmoke" style="width: 150px">Unit Cost</TD>
							<TD bgColor="white">
						...
						<TR>
							<TD bgColor="whitesmoke" style="width: 150px">Description</TD>
							<TD bgColor="white">
						...
						<tr id=trCheckLandscape runat=server>
							<td bgcolor="whitesmoke" style="width: 150px">
								Check landscape photos
						    </td>
							<td bgcolor="white" id=td2 runat=server>
								<asp:CheckBox ID="chkLandscape" runat="server" />
							</td>
						</tr>    
						<tr id=trUseOversizedEnvelopes runat=server>
							<td bgcolor="whitesmoke" style="width: 150px">
								Use oversized envelopes
						    </td>
							<td bgcolor="white" id=td3 runat=server>
								<asp:CheckBox ID="chkUseOversizedEnvelopes" runat="server" />
							</td>
						</tr>
						<tr>
							<td bgColor="whitesmoke" style="width: 150px">
							...
							<td bgColor="white">
								<asp:DropDownList id="ddlExportType" runat="server"></asp:DropDownList>
								<asp:RequiredFieldValidator id="RequiredFieldValidator5" runat="server" Display="Dynamic" ControlToValidate="ddlExportType"
									ErrorMessage="Required"></asp:RequiredFieldValidator>
							</td>
						</tr>     
						...
						<tr>
							...
							<td bgcolor="white">
								<asp:TextBox ID="txtLabUserName" runat="server"></asp:TextBox>
								<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLabUserName"
			...
			<TR>
				<TD>
					...
					&nbsp;&nbsp;
					<asp:Button ID="btnPerm" runat="server" Text="Permanently Delete" OnClick="btnPerm_Click" />
				</TD>
				<TD align="right">
					&nbsp;<input type=button value="Return" onclick="location.href='admin_products.aspx'" />
				</TD>
			</TR>
		</TABLE>
		<BR>
